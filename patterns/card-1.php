...
<!-- wp:group {"tagName":"section","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"layout":{"type":"constrained"},"metadata":{"name":"Card#1"}} -->
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-cover has-border-color has-contrast-border-color is-style-eternitywp-box-shadow has-soft-border-color" style="border-width:1px;border-radius:25px">
                ...
                <div class="wp-block-cover__inner-container">
                    <!-- wp:group {"style":{"border":{"radius":"10px"},"spacing":{"padding":{"right":"var:preset|spacing|20","left":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
                    <div class="wp-block-group" style="border-radius:10px;padding-right:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">
                        ...
                        <p class="has-text-align-center has-contrast-color has-text-color has-link-color has-x-small-font-size"><strong><a href="<?php echo esc_url('#')?>"><?php echo esc_html__('Show More','fleks') ?> </a>🡢 </strong></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
