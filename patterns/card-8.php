...
<!-- wp:group {"tagName":"section","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"layout":{"type":"constrained"},"metadata":{"name":"Card#8"}} -->
        ...
        <div class="wp-block-column" style="border-style:none;border-width:0px">
            ...
            <div class="wp-block-cover has-border-color has-contrast-border-color is-style-fleks-box-shadow" style="border-style:none;border-width:0px">
                ...
                <div class="wp-block-cover__inner-container">
                    ...
                    <div class="wp-block-group has-white-color has-text-color has-link-color" style="padding-right:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">
                        ...
                        <p class="has-text-align-center has-xx-large-font-size"><?php echo esc_html('⚏')?></p>
                        <!-- /wp:paragraph -->
                        ...
                        <!-- /wp:paragraph -->
                        <!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"x-small"} -->
                        <p class="has-text-align-center has-x-small-font-size" style="font-style:normal;font-weight:700"><a href="<?php echo esc_url('#')?>"><?php echo esc_html__('SHOW MORE','fleks') ?> </a><strong>🡢</strong></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
