...
add_action( 'tgmpa_register', 'fleks_register_recommended_plugins' );
function fleks_register_recommended_plugins(): void {
    // Recommended plugins
    $plugins = array(
        array(
            'name'      => 'Block Style Modifiers',
            'slug'      => 'block-style-modifiers',
            'required'  => false,
        )
    );
    ...
    $config = array(
        'id'           => 'fleks',                 // Unique ID for hashing notices for multiple instances of TGMPA.
